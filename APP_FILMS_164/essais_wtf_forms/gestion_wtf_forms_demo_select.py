...
def demo_select_wtf():
    ...
    # Objet formulaire pour montrer une liste déroulante basé su    r la table "t_produit"
    ...
    try:
        ...
        if request.method == "GET":
            with DBconnection() as mc_afficher:
                strsql_genres_afficher = """SELECT Nom_Prod, Nom_Prod FROM t_produit ORDER BY Nom_Prod ASC"""
            ...
            # genre_val_list_dropdown = [(i["Nom_Prod"], i["intitule_genre"]) for i in data_genres]

...
class FormWTFAjouterGenres(FlaskForm):
    ...
    nom_genre_wtf = StringField("Nom du produit : ", validators=[Length(min=2, max=20, message="min 2 max 20"),
    ...
    submit = SubmitField("Enregistrer Produits")
...
class FormWTFUpdateGenre(FlaskForm):
    ...
    nom_genre_update_wtf = StringField("Nouveau type de produit ", validators=[Length(min=2, max=20, message="min 2 max 20"),
